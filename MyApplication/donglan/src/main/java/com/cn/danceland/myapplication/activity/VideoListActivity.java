...
public class VideoListActivity extends BaseRecyclerViewRefreshActivity {
    ...
    private void getHeaderData() {
        ...
        MyStringRequest myStringRequest = new MyStringRequest(Request.Method.POST, Constants.QUERYVIDEOTYPE, new Response.Listener<String>() {
            @Override
    ...
    private void getListData() {
        ...
        MyStringRequest myStringRequest = new MyStringRequest(Request.Method.POST, Constants.QUERYVIDEO, new Response.Listener<String>() {
            @Override
            public void onResponse(String s) {
                LogUtil.i(s);
