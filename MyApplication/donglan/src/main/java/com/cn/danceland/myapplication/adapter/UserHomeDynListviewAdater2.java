...
public class UserHomeDynListviewAdater2 extends BaseAdapter {
    ...
    public UserHomeDynListviewAdater2(Context context, ArrayList<RequsetDynInfoBean.Data.Content> data) {
...
//        LogUtil.i(data.toString());
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.listview_item_dynamic_two, null);
...
//                    linearParams.setMargins(0, DensityUtils.dp2px(context, 5f), 0, 0);
                ...
                viewHolder.gridView.setAdapter(new ImageGridAdapter2(context, data.get(position).getImgList()));
                /**
                 * 图片列表点击事件
                 */
...
//                context.startActivity(intent);
    ...
    private void addZan(final String msgId, final boolean isPraise, final int pos) {
        ...
        MyJsonObjectRequest request = new MyJsonObjectRequest(Request.Method.POST, Constants.ADD_ZAN_URL, new Gson().toJson(strBean), new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject jsonObject) {
