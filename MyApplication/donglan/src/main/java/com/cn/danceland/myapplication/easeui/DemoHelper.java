package com.cn.danceland.myapplication.easeui;
...
import com.cn.danceland.myapplication.db.DemoDBManager;
import com.cn.danceland.myapplication.db.InviteMessage;
import com.cn.danceland.myapplication.db.InviteMessgeDao;
import com.cn.danceland.myapplication.db.UserDao;
...
//                break;
    ...
    private EaseUser getUserInfo(String username) {
        ...
        if (username.equals(EMClient.getInstance().getCurrentUser())) {
            if (user == null) {
                String username1 = EMClient.getInstance().getCurrentUser();
                user = new EaseUser(username1);
                String nick = PreferenceManager.getInstance().getCurrentUserNick();
                user.setNick((nick != null) ? nick : username);
