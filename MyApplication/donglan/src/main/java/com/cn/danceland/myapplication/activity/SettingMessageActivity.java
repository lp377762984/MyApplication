...
public class SettingMessageActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void getData() {
        MyStringRequest stringRequest = new MyStringRequest(Request.Method.GET, Constants.PUSH_RECEIVE_LIST, new Response.Listener<String>() {
            @Override
    ...
    public void saveData(final SaveBean paramsB, ImageView imageview) {
        MyStringRequest stringRequest = new MyStringRequest(Request.Method.POST, Constants.PUSH_RECEIVE_SAVE, new Response.Listener<String>() {
            @Override
            public void onResponse(String s) {
                LogUtil.i("Response--" + s);
