...
import static com.cn.danceland.myapplication.utils.Constants.VALIDATE_IDENTITYCARD_URL;
...
public class BindSFZActivty extends BaseActivity {
    ...
    private void yanzhengshenfen() {
        MyStringNoTokenRequest myStringNoTokenRequest = new MyStringNoTokenRequest(Request.Method.POST, VALIDATE_IDENTITYCARD_URL, new Response.Listener<String>() {
            @Override
