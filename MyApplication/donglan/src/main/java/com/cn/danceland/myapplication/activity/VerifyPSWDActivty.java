...
public class VerifyPSWDActivty extends BaseActivity {
    ...
    private void yanzhengshenfen() {
        MyStringNoTokenRequest myStringNoTokenRequest = new MyStringNoTokenRequest(Request.Method.POST, Constants.VERIFY_PHONEPASSWORD, new Response.Listener<String>() {
            @Override
