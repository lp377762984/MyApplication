...
public class PullRefreshLayout extends RelativeLayout {
    ...
    public void setHeader_layout(LinearLayout header_layout) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (!mStart) {
                    ...
                    if (mVisibleCanScoll) {
                        ...
                        mStartY = endY;
//                        NewHomeFragment.setHeader(offset);
                    }
...
//                    NewHomeFragment.setHeader(offset);
//                    LinearLayout.LayoutParams lppTemp = (LinearLayout.LayoutParams) header_layout.getLayoutParams();
//                    lppTemp.setMargins(0, -50, 0, 0);
