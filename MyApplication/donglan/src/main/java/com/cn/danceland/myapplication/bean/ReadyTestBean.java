...
public class ReadyTestBean {
        ...
        public void setAware_way(int aware_way) {
            this.aware_way = aware_way;
        }
        public int getAware_way() {
            return aware_way;
        }
        ...
        public void setFitness_level(int fitness_level) {
        ...
        public void setFollow_level(int follow_level) {
